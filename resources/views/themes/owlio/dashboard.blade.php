                                    ...
                                    <table class="table card-table">
                                                ...
                                                <div class="d-flex align-items-center intuition-profile">
                                                    <div class="me-sm-4 me-2">
                                                        <img src="images/profile/small/pic1.jpg"
                                                             class="rounded-circle" alt="" width="64">
                                                    </div>
                                                    <div class="info">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center intuition-profile">
                                                    <div class="me-sm-4 me-2">
                                                        <img src="images/profile/small/pic2.jpg"
                                                             class="rounded-circle" alt="" width="64">
                                                    </div>
                                                    <div class="info">
                                                        <h5 class=" mb-0"><a class="text-black" href="events.html">Helena
                                                                Khan</a></h5>
                                                        <span class="">ID 12314125</span>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center intuition-profile">
                                                    ...
                                                    <div class="info">
                                                        <h5 class=" mb-0"><a class="text-black" href="events.html">Melinda
                                                                Truth</a></h5>
                                                        <span class="">ID 12314125</span>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center intuition-profile">
                                                    ...
                                                    <div class="info">
                                                        <h5 class=" mb-0"><a class="text-black" href="events.html">Hawkins
                                                                Jr.</a></h5>
                                                        <span class="">ID 12314125</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="loadmore-content height800 dz-scroll" id="DietMenusContent">
                                <div class="card-body border-bottom">
                                    ...
                                    <div class="info">
                                        <h5 class="text-black mb-3"><a href="ecom-product-detail.html"
                                                                       class="text-black">Spinach with Roasted
                                                Crab</a></h5>
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <svg class="me-2 primary-icon" width="21" height="18"
                                                     ...
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="2.95455" height="18" rx="1.47727"
                                                          fill="#1E33F2"></rect>
                                                    <rect x="5.90918" y="4.90906" width="2.95455" height="13.0909"
                                                          rx="1.47727" fill="#1E33F2"></rect>
                                ...
                                <div class="card-body border-bottom">
                                    ...
                                    <div class="info">
                                        <h5 class="text-black mb-3"><a href="ecom-product-detail.html"
                                                                       class="text-black">Chicken Teriyaki Khas Haji
                                                Muhidin Malang</a></h5>
                                        <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="card-body border-bottom">
                                    ...
                                    <div class="info">
                                        <h5 class="text-black mb-3"><a href="ecom-product-detail.html"
                                                                       class="text-black">Fried Chicken Roll Extra
                                                Spiciy with Mozarella</a></h5>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h4 class="font-w600 mb-0 fs-16 text-primary text-uppercase">For
                                                Breakfast</h4>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-footer  border-0 pt-0 text-center">
                                        <a href="javascript:void(0);" class=" btn-block btn-primary btn ">View 240
                                            More</a>
                                    </div>
                                </div>
