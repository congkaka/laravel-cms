...
<div id="main-wrapper" class="show">
    ...
    <div class="nav-header">
        <a href="{{route('home')}}" class="brand-logo">
            <!-- <img src="{{asset("/owlio/images/logo.png")}}" alt="" height="54"> -->
    ...
    <!--***Header start********-->
    @include('themes.owlio.layouts.header')
    <!--****Header end ti-comment-alt******-->

    <!--*******Sidebar start*********-->
    @include('themes.owlio.layouts.sidebar')
    <!--*****Sidebar end********-->
    ...
    @include('themes.owlio.layouts.footer')
</div>
<!-- Required vendors -->
...
{{--<script src="{{asset('owlio/vendor/bootstrap-datetimepicker/js/moment.js')}}"></script>--}}
{{--<script src="{{asset('owlio/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>--}}
<script src="{{asset('owlio/vendor/peity/jquery.peity.min.js')}}"></script>
{{--<!-- Apex Chart -->--}}
{{--<script src="{{asset('owlio/vendor/apexchart/apexchart.js')}}"></script>--}}
{{--<!-- Dashboard 1 -->--}}
{{--<script src="{{asset('owlio/js/dashboard/dashboard-1.js')}}"></script>--}}
...
<script>
    ...
    fbq('init', '420926210939720');
    fbq('track', 'PageView');
</script>
<noscript>
    <img height="1" width="1" style="display:none"
         src="https://www.facebook.com/tr?id=420926210939720&ev=PageView&noscript=1"/>
</noscript>
<!-- End Meta Pixel Code -->
