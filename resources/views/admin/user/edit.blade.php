                            ...
                            <div class="card-body pt-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="required form-label">Số dư</label>
                                            <!--end::Label-->
                                            <input type="text" name="balance" disabled value="{{$item->balance}}" class="form-control"/>
                                        </div>

                                        <div class="mb-10 fv-row">
                                            <!--begin::Label-->
                                            <label class="required form-label">Cộng thêm ví</label>
                                            <!--end::Label-->
                                            <input type="number" name="add" value="0" class="form-control"/>
                                        </div>
                                        <div class="mb-10 fv-row">
