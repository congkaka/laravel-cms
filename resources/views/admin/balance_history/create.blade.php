    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Add BalanceHistory</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="kt_balance_history_form" method="post" action="{{route('admin.balance_history.store')}}" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10">
                    @csrf
                    <!--begin::Main column-->
                    <div class="d-flex flex-column flex-row-fluid gap-12 gap-lg-12">
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('admin.balance_history.index')}}" id="kt_balance_history_cancel" class="btn btn-light me-5">Quay lại</a>
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button type="submit" id="kt_balance_history_submit" class="btn btn-primary">
