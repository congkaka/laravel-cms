    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="kt_order_form" method="post" action="{{route('admin.order.store')}}" class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10">
                    @csrf
                    <!--begin::Main column-->
                    <div class="d-flex flex-column flex-row-fluid gap-12 gap-lg-12">
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('admin.order.index')}}" id="kt_order_cancel" class="btn btn-light me-5">Quay lại</a>
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button type="submit" id="kt_order_submit" class="btn btn-primary">
