    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <a href="{{route('admin.product.create')}}" class="btn btn-sm fw-bold btn-primary">Thêm</a>
                <!--end::Page title-->
            </div>
            <!--end::Container-->
        </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_product_table">
                            ...
                            @foreach($items as $i)
                                <tr>
                                    <td>
                                        <a href="{{route('admin.product.show', ['product' => $i['id']])}}">{{$i['id']}}</a>
                                    </td>
                                    <td>
                                        {{$i['name']}}
                                    </td>
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input active_product" data-api="{{ route('admin.product.change_active', $i->id) }}"
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div
                                            ...
                                            data-kt-menu="true">
                                            <div class="menu-item">
                                                <a href="{{route('admin.product.show', $i['id'])}}" class="menu-link"><i
                                                        class="bi bi-ticket-detailed text-success pe-3"></i>Chi tiết</a>
                                            </div>
                                            <div class="menu-item">
                                                <a href="{{route('admin.product.edit', $i['id'])}}" class="menu-link"><i
                                                        class="bi bi-pencil-square text-warning pe-3"></i>Sửa</a>
                                            </div>
                                            <div class="menu-item">
                                                <a href="{{route('admin.product_variant.create',['productId' => $i['id']])}}"
                                                   class="menu-link"><i
                                                        class="bi bi-plus-circle-fill text-primary pe-3"></i>Thêm
                                                    giá</a>
                                            </div>
                                            <div class="menu-item">
                                                <a href="{{route('admin.product.destroy', $i['id'])}}"
