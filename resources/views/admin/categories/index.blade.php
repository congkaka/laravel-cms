        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Dịch vụ</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                ...
                <a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
                   data-bs-target="#kt_modal_create_app">Thêm</a>
                <!--end::Page title-->
            </div>
            <!--end::Container-->
        </div>
                            ...
                            @foreach($items as $i)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <!--begin::Menu-->
                                        <div
                                            class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-175px"
                                            data-kt-menu="true">
                                            {{--                                            <div class="menu-item">--}}
                                            {{--                                                <a href="{{route('admin.categories.show', $i['id'])}}" class="menu-link"><i class="bi bi-ticket-detailed text-success pe-3"></i>Chi tiết</a>--}}
                                            {{--                                            </div>--}}
                                            <div class="menu-item">
                                            ...
                                            <div class="menu-item">
                                                <a href="{{route('admin.product.create',['categoryId' => $i['id']])}}"
                                                   class="menu-link"><i
                                                        class="bi bi-plus-circle-fill text-primary pe-3"></i>Thêm dịch
                                                    vụ</a>
                                            </div>
                                            <div class="menu-item">
        ...
        <div class="modal-dialog modal-dialog-centered mw-900px">
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-10 px-lg-10">
                    <form id="kt_account_profile_details_form" class="form" action="{{route('admin.categories.store')}}"
                          method="post">
                        @csrf
                        <div class="card-body border-top p-9">
                            <div class="row mb-6">
                                ...
                                <div class="col-md-8 row">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">Tên</label>
