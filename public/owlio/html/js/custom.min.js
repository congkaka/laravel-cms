        ...
        E = function() {
            if (jQuery(".dz-theme-mode").length > 0) {
                jQuery(".dz-theme-mode").on("click", function() {
                    jQuery(this).toggleClass("active"), jQuery(this).hasClass("active") ? (jQuery("body").attr("data-theme-version", "dark"), setCookie("data-theme-version", "dark")) : (jQuery("body").attr("data-theme-version", "light"), setCookie("data-theme-version", "light"))
                });
                var e = getCookie("data-theme-version");
                jQuery("body").attr("data-theme-version", e), jQuery(".dz-theme-mode").removeClass("active"), "dark" == e && jQuery(".dz-theme-mode").addClass("active")
            }
        };
    return {
        init: function() {
            n(), a(), o(), i(), s(), c(), r(), d(), u(), h(), m(), f(), p(), g(), z(), v(), b(), C(), k(), w(), x(), y(), F(), l(), E()
        },
        load: function() {
            n(), t()
        },
